...
$(document).ready(function () {
  ...
  //Current date.
  let NowMoment = moment().format("ll");
  
  //Adds days to moment for five day forecast.
 ...
 //Loads most recently searched city from local storage.
  ...
  //Retrieves city name, inputted by user.
  function getCity() {
    city = $("#city-input").val();
  ...
  //Searchs API for city.
  function search() {
    
    let queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial&appid=f821137c13531b9f61152f33c0224339";
    let coords = [];
    ...
    //Gets the five day forecast and UV index. Displays them on page.
    function getUV(lat, lon) {
      ...
      $.ajax({
        ...
        //Determines UV index and applies different css properties based on severity.
        ...
        //Temp variables for five day forecast.
        ...
        //Humidity variables for five day forecast.
        ...
        //Icon variables for five day forecast.
...
//Displays recently searched cities to page.
  function listCities() {
    $("#cityList").text("");
    cities.forEach((city) => {
